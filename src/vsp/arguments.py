...
def args():
    ...
    parser.add_argument('--N_ROLLOUT', default=20) #Standard: 20
    parser.add_argument('--ROLLOUT_STEPS', default=10) #Standard: 10
...
def args():
    parser = argparse.ArgumentParser()
    parser.add_argument('-n', '--N_JOBS', default=5)
    ...
    parser.add_argument('--REMOVE_NUMBER', default=1)
    parser.add_argument('--init_T', default=5000.0)
    parser.add_argument('--final_T', default=1.0)
    parser.add_argument('--device', default="cpu")
    return parser.parse_args()
